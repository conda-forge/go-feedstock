...
Development: https://github.com/conda-forge/go-feedstock
...
Once the `conda-forge` channel has been enabled, `go, go-cgo, go-cgo_linux-64, go-cgo_linux-aarch64, go-cgo_linux-ppc64le, go-cgo_osx-64, go-cgo_win-64, go-nocgo, go-nocgo_linux-64, go-nocgo_linux-aarch64, go-nocgo_linux-ppc64le, go-nocgo_osx-64, go-nocgo_win-64` can be installed with `conda`:

```
conda install go go-cgo go-cgo_linux-64 go-cgo_linux-aarch64 go-cgo_linux-ppc64le go-cgo_osx-64 go-cgo_win-64 go-nocgo go-nocgo_linux-64 go-nocgo_linux-aarch64 go-nocgo_linux-ppc64le go-nocgo_osx-64 go-nocgo_win-64
```

or with `mamba`:

```
mamba install go go-cgo go-cgo_linux-64 go-cgo_linux-aarch64 go-cgo_linux-ppc64le go-cgo_osx-64 go-cgo_win-64 go-nocgo go-nocgo_linux-64 go-nocgo_linux-aarch64 go-nocgo_linux-ppc64le go-nocgo_osx-64 go-nocgo_win-64
```
